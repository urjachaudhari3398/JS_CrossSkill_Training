...
/**
 * Write a function that sorts an array of objects
 * by the key that is passed in the second argument,
...
/**
 * Given 2 arrays with related objects,
 * return a new array where objects having the same id from each of the arrays are merged.
